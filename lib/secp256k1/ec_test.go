...
func TestWNAF(t *testing.T) {
	...
	var testvcs = []wnafvec{
		{
			"3271156f58b59bd7aa542ca6972c1910", WindowA,
		...
		{
			"0a8a5afcb465a43b8277801311860430", WindowA,
		...
		{
			"b1a74471baaf1a3a8b9005821491c4b4", WindowG,
		...
		{
			"b618eba71ec03638693405c75fc1c9ab", WindowG,
